  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-r from-[#06142E] via-[#0A2F76] to-[#2666D2] text-white">
      <SiteContainer className="relative z-10 grid min-h-screen max-w-none gap-10 pt-28 pr-0 pb-12 sm:pr-0 md:pr-0 lg:grid-cols-[minmax(0,1fr)_370px] lg:items-stretch lg:pt-24 lg:pr-0 lg:pb-0 xl:grid-cols-[minmax(0,1fr)_420px] xl:pr-0">
        <div className="flex min-h-[54vh] flex-col justify-end pb-8 lg:min-h-0 lg:pb-24">
          <h1 className="text-[58px] font-[300] leading-[1.05] tracking-0 sm:text-[76px] lg:text-[88px]">
            Knowledge Hub
          </h1>
          <p className="mt-7 max-w-[690px] text-[18px] font-[300] leading-[1.5] text-white sm:text-[20px]">
            Leveraging advanced technologies and innovative solutions, we tackle
            complex business challenges, delivering scalable, efficient, and
            future-ready digital products that drive growth and market
            leadership
          </p>
        </div>
