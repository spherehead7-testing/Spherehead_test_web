        ...
        >
                ...
                <SiteContainer className="h-full">
                    <div className="flex h-full flex-col items-center justify-center gap-6 px-6 pt-10 pb-10 text-center">
                        ...
                        <h2 className="heading-2 max-w-[1257px] !text-black !text-center font-bold">
                            ...
                            technology
                            <br />
                            solutions company delivering end-to-end digital
                            services,
                            <br />
                ...
                <div className="flex h-full items-center px-10 pl-6 sm:px-14 lg:px-16 lg:pl-24">
                    <div className="flex w-full max-w-[912px] items-start justify-start gap-12">
                        ...
                        {statsData.map((stat) => (
                            ...
                            >
                                <span className="heading-1 !leading-none">
                                    {stat.value}
                                </span>
                                <span className="body-small text-[#e8e8e8] mt-3 leading-snug tracking-[1.2px] !text-[16px] whitespace-nowrap">
                                    {stat.label}
                                </span>
                            </div>
                        ))}
            ...
            >
                <div className="flex h-full flex-col items-start bg-[#ffffff] px-6 pl-6 pt-10 pb-8 sm:px-8 lg:px-14 lg:pl-14">
                    <p className="body-small text-[#55565C] max-w-[420px] !text-[16px] !leading-[1.4]">
                        Driven by client satisfaction and continuous feedback,
                        we deliver tailored digital solutions that empower
                        businesses worldwide, building lasting partnerships
