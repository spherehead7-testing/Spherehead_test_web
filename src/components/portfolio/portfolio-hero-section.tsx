...
export default function PortfolioHeroSection() {
  return (
    <section className="relative w-full h-[100svh] flex flex-col overflow-hidden">
      ...
      {/* Main Content Area */}
      <SiteContainer className="relative z-10 flex flex-col h-full flex-grow justify-end pb-8 pt-32 lg:pb-12">
        <div className="w-full flex flex-col mt-auto">
          ...
          <motion.div 
            ...
            className="w-full h-[1px] bg-white/20 mb-8 lg:mb-12 origin-left" 
          />
