  ...
  return (
    ...
    >
      ...
      <SiteContainer className="relative flex flex-col justify-center py-6 lg:py-10 h-full max-h-[950px]">
        <motion.div
          style={{ opacity: content1Opacity, y: content1Y }} // Keep this!
          className="w-full max-w-[1100px]"
        >
          <p className="heading-2 !text-[#01030B]">
            With a passionate team driving{" "}
            <span className="text-[#0D54CA]">innovation</span>, Spherehead
            delivers cutting-edge{" "}
            <span className="text-[#0D54CA]">digital services</span> that help
            brands grow, adapt, and stand out in{" "}
            <span className="text-[#0D54CA]">today’s competitive</span>{" "}
            landscape.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3.5fr_6.5fr] gap-8 lg:gap-16 items-center w-full">
          ...
          >
            ...
            <p className="heading-3" style={{ color: "#01030B" }}>
              We focus on creating meaningful digital experiences that connect
              your business with real growth, because that’s where true
              transformation begins and lasting success is achieved.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 mt-2 lg:mt-4">
              ...
              >
                ...
                explore how your digital presence can better serve your
                audience.
              </p>
              ...
              <p
                ...
                style={{ color: "#8A8B8F", lineHeight: "1.6" }}
              >
                The real impact happens when strategy and execution come
                together. We shape solutions that enhance performance, improve
                efficiency, and elevate your brand experience.
              </p>
            </div>
          </motion.div>
        </div>
