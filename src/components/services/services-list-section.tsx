...
const servicesData: Service[] = [
  {
    ...
    image:
      "https://res.cloudinary.com/dku9in8sb/image/upload/v1776399464/services_list_ny50qm.png",
  },
  {
    id: "02",
...
// Array containing the exact repeating color sequence for the Plus icons
const plusIconColors = [
  "text-[#FD7624]", // 1st: Orange
  "text-[#0D54CA]", // 2nd: Dark Blue
  "text-[#92D9FF]", // 3rd: Light Blue
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[4.5fr_5.5fr] gap-12 lg:gap-24 items-start h-full">
              ...
              >
                ...
                {servicesData.map((service, index) => {
                  ...
                  // This grabs the color based strictly on its position in the array
                  const currentPlusColor = plusIconColors[index % 3];

                  return (
                    <div
                      key={service.id}
                      className="group border-b border-[#e8e8e8] py-5 lg:py-6 transition-colors duration-300"
                    >
                      <div
                      ...
                      >
                        <div className="flex items-center gap-6 lg:gap-10">
                          {/* Number is uniformly Dark Blue based on your image */}
                          <span className="body-large text-[#0D54CA]">
                            {service.id}
                          </span>

                          {/* Title is uniformly Dark Black based on your image */}
                          <h3 className="body-large text-[#01030B]">
                            {service.id === "04" && isActive
                        ...
                        <button className="p-2 -mr-2 cursor-pointer focus:outline-none">
                          {/* Exact ordered color sequence applied to the Plus icon */}
